# Contribute to WPCS Core Extra Sniffs
...
* [open an issue](https://github.com/GoogleChromeLabs/wpcs-core-extra-sniffs/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/GoogleChromeLabs/wpcs-core-extra-sniffs/compare) to the `main` branch
